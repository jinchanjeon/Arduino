...
//////////
char toRandCharEn(int nRand) //소문자 + 대문자
{
...
String makeRandAll(int nRandSize)
{
  String sRand;
...
String makeRandEn(int nRandSize)
{
  String sRand;
  for (int i = 0; i < nRandSize; i++)
  {
...
void setup() {
  ...
  initGame();
  Serial.println("1. 영어+숫자+구두점");
  Serial.println("2. 영어만");
}
